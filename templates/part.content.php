...
<script id="content-tpl" type="text/x-handlebars-template">
	...
	<div class="input"><textarea id="note_content" title="note_content">{{ note.content }}</textarea></div>
	<div class="save"><button id="save_btn" ><?php p($l->t('Save')); ?></button></div>
	{{else}}
	<div class="input"><textarea disabled id="non_note_content" title="non_note_content"></textarea></div>
	<div class="save"><button id="save_btn"  disabled><?php p($l->t('Save')); ?></button></div>
	{{/if}}
</script>
<div id="editor"></div>
